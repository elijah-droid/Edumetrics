...
from .views import schools_listing, apply, parent_applications, school_applications, applicant_profile, approve_application
...
urlpatterns = [
    ...
    path('approve/<int:application>/', approve_application, name='approve-application')
]